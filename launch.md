...
- [ ] **The canonical link is `https://github.com/notinferred/keypaste`** and every post below uses it. If the `keypaste` org from step 0.4 is ever registered, that is a move to make before a launch, never after.
