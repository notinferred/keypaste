...
- [ ] **3.2 — Publish the initial community introduction (H-0006).** Human. Needs: none. Ships after: founder daily use of the `0.3.0` release R.0f published (PRODUCT §5.2). — Refresh [launch.md](../launch.md) for the product actually released, then post once per sanctioned channel (D-0196).
