...
Recovery comes before broader feature depth. Completed T1 steps and their evidence are in [steps](steps/README.md). The task below is the next detailed implementation candidate in this track, and it is not selected. It uses the existing shared core and traces to PRODUCT §§1, 2 and 5.7.
...
- [ ] **U.2 — Enforce the common lock boundary.** Needs: U.1.
