...
**Next: R.0a — pin release identity and the supported platform contract.** Every repair that can be
finished without new hardware is finished. F.2b2 is BLOCKED on a macOS machine and a Linux desktop
