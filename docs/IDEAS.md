...
> Ideas wait here. Most wait forever, and that is the point (`docs/PRODUCT.md` law 5.5). Nothing here is a step. It becomes one only when it can name an accept criterion that can *fail* and carry a Verify line — the admission rule at the top of `docs/STEPS.md`.
>
