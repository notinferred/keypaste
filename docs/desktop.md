...
Env Sets shows project cards with a copyable `keypaste run <project> -- ` command. The copied CLI command opens the vault separately, asks for its password and closes it before starting the child; it does not reuse the desktop session.
