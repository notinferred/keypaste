...
Implementation: [Vault](../src/Keypaste.Core/Vault.cs), [format boundary](../src/Keypaste.Core/Internal/KeePassInterop.cs), [desktop session](../src/Keypaste.App/Session/AppVaultSession.cs), [entries](../src/Keypaste.App/ViewModels/EntriesViewModel.cs), [editing](../src/Keypaste.App/ViewModels/EntryDetailViewModel.cs), [history](../src/Keypaste.App/ViewModels/EntryHistoryViewModel.cs), [trash](../src/Keypaste.App/ViewModels/TrashViewModel.cs), [backups](../src/Keypaste.Core/VaultBackups.cs). Existing coverage includes vault round-trip/save/history suites, desktop session and secret-input suites, [CLI/desktop consistency tests](../tests/Keypaste.Consistency.Tests/README.md), and KeePassXC compatibility scripts. [The desktop guide](desktop.md) records native verification limits.
