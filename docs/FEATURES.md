...
| Desktop installation and updates | App builds from source; CI builds an internal unsigned Windows MSI; no public desktop installer. | 4.7a–d cover candidates, native installation, upgrades/recovery and public downloads; 3.5a–b/3.6a–b cover macOS/Windows signing. R.1 verifies the complete product. [RELEASE.md](RELEASE.md) owns platform/channel evidence. |
