...
Reviewed 2026-09-07 against PRODUCT v1.2; milestone mappings updated 2026-09-15 for PRODUCT v1.4 (D-0176). This is a first-pass capability inventory.
...
| Desktop installation and updates | App builds from source; CI builds an internal unsigned Windows MSI and Linux AppImage; no public desktop installer. | 4.7a–d cover candidates, native installation, upgrades/recovery and public downloads; 3.5a–b/3.6a–b cover macOS/Windows signing of the app and CLI/MCP binaries. R.1 verifies the developer journey. [RELEASE.md](RELEASE.md) owns platform/channel evidence. |
