...
#if NETSTANDARD2_0 && !KEYPASTE_NO_DPAPI
...
namespace KeePassLib.Cryptography
{
	...
	public static class CryptoUtil
	{
		...
		// keypaste: the port substituted Microsoft.AspNetCore.DataProtection for Windows
		// DPAPI here, backed by an *ephemeral* provider that also creates a key directory
