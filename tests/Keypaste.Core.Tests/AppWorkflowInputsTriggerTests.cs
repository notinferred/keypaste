...
public sealed class AppWorkflowInputsTriggerTests
{
    ...
    [InlineData("scripts/build-linux-appimage.sh", true)]
    [InlineData("scripts/verify-linux-appimage.sh", true)]
    [InlineData("scripts/fetch-pinned-asset.sh", true)]
    [InlineData("packaging/linux/com.keypaste.app.desktop", true)]
