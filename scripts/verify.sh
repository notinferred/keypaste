...
profiles_for_path() {
  case "$1" in
    ...
    scripts/verify-session-authority.sh|scripts/verify-lock-boundary.sh|scripts/verify-current-state.sh|scripts/verify-session-lifecycle.sh|scripts/verify-desktop-approval.sh) echo scripts desktop ;;
